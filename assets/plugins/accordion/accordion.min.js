/*!  * Accordion v2.8.0  * Simple accordion created in pure Javascript.  * https://github.com/michu2k/Accordion  *  * Copyright 2017-2019 Michał Strumpf  * Published under MIT License  */ "use strict";
!(function (i) {
  function u(o, l) {
    var c = this,
      t = {
        ...
        closeAllElements: function (e) {
          for (
            var t = this.options.aria, n = this.elements.length, i = 0;
            i < n;
            i++
          )
            if (i != e) {
