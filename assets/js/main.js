$(function () {
  ...
  function mainSlider() {
    ...
    BasicSlider.on("init", function (e, slick) {
      var $firstAnimatingElements = $(".banner-area:first-child").find(
        "[data-animation]"
      );
      doAnimations($firstAnimatingElements);
    });
    BasicSlider2.on("init", function (e, slick) {
      var $firstAnimatingElements = $(".banner-3-area:first-child").find(
        "[data-animation]"
      );
      doAnimations($firstAnimatingElements);
    });
    ...
    BasicSlider.on(
      ...
      function (e, slick, currentSlide, nextSlide) {
        var $animatingElements = $(
          '.banner-area[data-slick-index="' + nextSlide + '"]'
        ).find("[data-animation]");
    ...
    BasicSlider2.on(
      ...
      function (e, slick, currentSlide, nextSlide) {
        var $animatingElements = $(
          '.banner-3-area[data-slick-index="' + nextSlide + '"]'
        ).find("[data-animation]");
        doAnimations($animatingElements);
      }
    );
    ...
    BasicSlider.slick({
      ...
      arrows: true,
      prevArrow:
        '<span class="prev"><i class="flaticon-arrow"></i></span"></i></span>',
      nextArrow:
