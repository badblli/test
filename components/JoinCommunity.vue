      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="join-community-content">
            <h3
              class="title animated wow fadeInLeft"
            ...
            <p class="animated wow fadeInLeft">
              Lorem ipsum is simply free text dolor sit amett adipiscing elit.
              When an unknown printer took a galley of type and scrambled it to
              make a type specimen book.
            </p>
            <nuxt-link class="main-btn animated wow fadeInLeft" to="/about"
              >Read more</nuxt-link
            >
          </div>
        </div>
