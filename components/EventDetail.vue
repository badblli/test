        ...
        <div class="col-lg-6">
          <div class="event-details-content">
            ...
            <p>
              ...
              available in the majority sed do eius tempor incididunt ut labore
              et alteration in some. Quuntur magni dolores eos qui ratione
              voluptatem sequi nesciunt.
            </p>
            <p class="text">
              Neque porro quisquam est, qui dolorem ipsum quiaolor sit amet,
              consectetur, adipisci velit, sed quia non numquam eius modi
              tempora incidunt ut labore et dolore magnam dolor sit amet,
        ...
        <div class="col-lg-6">
          <div class="event-details-thumb">
            <nuxt-img
              loading="lazy"
              placeholder="blur"
              src="/assets/images/event-details-thumb.jpg"
              alt=""
            />
          </div>
        </div>
